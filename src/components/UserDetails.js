...
const UserDetails = () => {
    ...
    // const { activeUser } = useSelector((state) => state.Admin_Register);
        ...
        try {
         const getUserById = async () => {
          //  const res = await axios.get("https://cominks.app/admin/getAllUsers")
           const res = await axios.get(`https://commention-backend.onrender.com/admin/getUser/${id}`)
           console.log(res.data.data,"getElementByid")
                ...
                <div className="results-container">
                    {!showCominks ? (
                        <div className='cominks-container'>
                            <h1>The generated comments are listed below:</h1>
